...
import 'package:rohos_app/models/app_exception.dart';
...
final rustDailyProvider =
    FutureProvider.family<RustDailyPageData, RustDailyParams>((
      ref,
      params,
    ) async {
      ...
      if (params.type == "list") {
        ...
        iLogger.i('Rust Daily 列表模式：共 $liItems 条 <li>，总页数 $totalPage');
